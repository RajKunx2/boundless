                ...
                <section class="mb-32 text-center">
                    ...
                    <div class="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
                        <div class="mb-12 md:mb-0">
                            ...
                            <h5 class="mb-2 text-lg font-bold">Manvi Mehra</h5>
                        ...
                        <div class="mb-12 md:mb-0">
                            ...
                            <h5 class="mb-2 text-lg font-bold"> Harshita Soni
                            </h5>
                            <h6 class="mb-4 font-medium text-primary dark:text-primary-400">
                                Partner Relation Manager
                            </h6>
                            <p class="mb-4">
                                As a student, I was thrilled to discover the marketing agency&apos;s unique approach of using sanitary napkin ad space. It caught my attention immediately and sparked my curiosity. Not only did it make me aware of the brand, but it also initiated a conversation about menstrual hygiene among my peers.
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960" class="inline-block w-6">
                                    <path fill="currentColor"
                                        d="M580 556h160V396H580v160Zm-360 0h160V396H220v160Zm406 220 80-160H520V336h280v288l-76 152h-98Zm-360 0 80-160H160V336h280v288l-76 152h-98Zm34-300Zm360 0Z" />
                                </svg>
                        ...
                        <div class="mb-0">
                            ...
                            <h5 class="mb-2 text-lg font-bold">Aaradhya Gupta </h5>
                            <h6 class="mb-4 font-medium text-primary dark:text-primary-400">
                                Student of Delhi University
                            </h6>
                            <p class="mb-4">
                                What impressed me the most was the company&apos;s &apos;Pad for Pad&apos; initiative. Knowing that for every pad distributed, they donated one to women in need truly touched my heart. It made me feel proud to support a brand that goes beyond profit and genuinely cares about making a positive difference in society.
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 96 960 960" class="inline-block w-6">
                                    <path fill="currentColor"
                                        d="M580 556h160V396H580v160Zm-360 0h160V396H220v160Zm406 220 80-160H520V336h280v288l-76 152h-98Zm-360 0 80-160H160V336h280v288l-76 152h-98Zm34-300Zm360 0Z" />
                                </svg>
