    ...
    return (
        <div className='flex flex-col lg:flex-row mt-[100px] justify-center items-center align-middle py-6'>
            <div className='flex flex-col md:mx-12 basis-1/3 justify-center items-center'>
                ...
                <p><button className='shadow-2xl rounded-lg px-4 py-2 text-base my-2 text-orange-400 border-orange-200 hover:text-white hover:bg-orange-500 border-2'>DONATE SANITARY PADS</button></p>
            </div>
